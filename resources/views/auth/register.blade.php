...
@section('content')
    ...
    <main class="main-content mt-0">
        <div class="page-header align-items-start min-vh-50 border-radius-lg m-3 pt-5 pb-11"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 mx-auto text-center">
                        ...
                        <p class="text-lead text-white">Di aplikasi pelayanan desa, memanagement data penduduk di desa
                            blablabla</p>
                    </div>
                </div>
            </div>
